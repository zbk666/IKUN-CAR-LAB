...
class PowerMonitor(QWidget):
    def __init__(self,bus,config):
        ...
        self.plot=pg.PlotWidget(title="Battery Voltage / Motor Current"); self.plot.showGrid(x=True,y=True,alpha=.2); self.plot.addLegend()
        self.cv=self.plot.plot(name="Battery V"); self.cl=self.plot.plot(name="Left Current A"); self.cr=self.plot.plot(name="Right Current A")
